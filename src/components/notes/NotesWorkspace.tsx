...
export function NotesWorkspace() {
  ...
  async function generateDiagram() {
    ...
    try {
      const body = await apiRequest<unknown>('/api/diagrams/generate', jsonBody({ noteId: note.id, contentMarkdown: note.contentMarkdown, content_markdown: note.contentMarkdown }));
